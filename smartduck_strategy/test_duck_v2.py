...
class TestDuck(unittest.TestCase):
  ...
  def test_rubber_duck(self):
    ...
    self.assertEqual(duck_obj.swim(), 'I can swim!')
    self.assertEqual(duck_obj.fly(), 'I can not fly!')

  def test_decoy_duck(self):
    duck_obj = duck.DecoyDuck()
    self.assertEqual(duck_obj.quack(), '...!')
    self.assertEqual(duck_obj.display(), 'I am a decoy duck :p')
    self.assertEqual(duck_obj.swim(), 'I can swim!')
    self.assertEqual(duck_obj.fly(), 'I can not fly!')
